...
const contactInfo =[
    {
        icon: Mail,
        label: "Email",
        value: "marcoantonio.aa09@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+55 (31) 98040-7581",
    },
    {
        icon: MapPin,
        label: "Location",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!serviceId || !templateId || !publicKey) {
                throw new Error(
                    "EmailJS configuration is missing. Please cheack your environment variables."
                );
            }
    ...
    return (
        <section id="contact" className="py-32 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full">
                ...
                <div className="absolute bottom-1/4 w-64 h-64 bg-hihjlight/5 rounded-full blur-3x;"/>
            </div>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full px-4 py-3 bg-surface rounded-xl border border-border focus:border-primary focus:ring01 focus:ring-primary outline-none transition-all"/>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 bg-surface rounded-xl border border-border focus:border-primary focus:ring01 focus:ring-primary outline-none transition-all resize-none"/>
                            </div>
